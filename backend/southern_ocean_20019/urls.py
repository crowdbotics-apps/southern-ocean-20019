"""southern_ocean_20019 URL Configuration
...
admin.site.site_header = "Southern Ocean"
admin.site.site_title = "Southern Ocean Admin Portal"
admin.site.index_title = "Southern Ocean Admin"

# swagger
api_info = openapi.Info(
    title="Southern Ocean API",
    default_version="v1",
    description="API documentation for Southern Ocean App",
)
